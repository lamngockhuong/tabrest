...
- **サイドパネルモード** - Chrome のサイドパネルで TabRest を開く (ツールバークリック時の既定動作として設定するか、ポップアップのヘッダーボタンから開く)
- **タブ/サイトのスヌーズ** - タブまたはドメインを一時的に保護 (30 分 - 2 時間)
- **グローバル一時停止** - すべての自動アンロードを一時的に停止 (30 分、1 時間、2 時間、または再開するまで)
...
- [Specpin](https://github.com/lamngockhuong/specpin) - 稼働中の Web UI の要素に生きたビジネス仕様をピン留め。Git ネイティブ、ローカルファースト、フレームワーク非依存
...
本プロジェクトの一部は [Drowzy](https://github.com/ml3dev/drowzy) に由来します。Copyright (c) 2026 ml3dev、MIT ライセンス。
