// SVG Icon System - Lucide-inspired icons for TabRest
// Usage: icon('moon', 16) returns SVG string
// Usage: injectIcons() replaces all [data-icon] elements
...
const ICONS = {
  ...
  memory: '<rect width="16" height="16" x="4" y="4" rx="2"/><rect width="6" height="6" x="9" y="9" rx="1"/><path d="M15 2v2M15 20v2M2 15h2M2 9h2M20 15h2M20 9h2M9 2v2M9 20v2"/>',
};

/**
 * Generate SVG element string
 ...
 * Call after rendering dynamic content to replace placeholders
 */
export function injectIcons() {
  document.querySelectorAll('[data-icon]').forEach(el => {
    const name = el.dataset.icon;
    const size = parseInt(el.dataset.iconSize || '14', 10);
