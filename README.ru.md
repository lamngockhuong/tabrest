...
- **Режим боковой панели** - Открытие TabRest в боковой панели Chrome (опционально как действие по умолчанию при клике на значок или через кнопку в шапке всплывающего окна)
- **Отложить вкладки/сайты** - Временная защита вкладок или доменов (30 мин - 2 часа)
- **Глобальная пауза** - Временная остановка всей автоматической выгрузки (30 мин, 1 час, 2 часа или до возобновления)
